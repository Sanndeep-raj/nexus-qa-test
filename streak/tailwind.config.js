...
module.exports = {
  ...
  safelist: [
    ...
    "backdrop-blur-sm",
    "bg-secondary",
    'w-[33px]', 'h-[33px]', 'w-[48px]', 'h-[48px]',
    'w-[58px]', 'h-[58px]', 'w-[80px]', 'h-[80px]',
    'w-[91px]', 'h-[91px]', 'w-[107px]', 'h-[107px]',
    'w-[140px]', 'h-[140px]',
    'opacity-30', 'opacity-50',
    'xl:w-[41px]', 'xl:h-[41px]', 'xl:hidden',
    'xl:w-[80px]', 'xl:h-[80px]', 'xl:w-[91px]', 'xl:h-[91px]',
    'xl:w-[140px]', 'xl:h-[140px]',
    'opacity-30', 'opacity-50',
    'p-1', 'w-[97%]', 'h-[97%]', 'w-full',
    'text-primary', 'rotate-180', 'fill-primary',
    "max-h-[600px]",
    "rotate-180",
    "bg-[url('/images/vbrandx/card-bg-1.webp')]",
    "bg-[url('/images/vbrandx/card-bg-2.webp')]",
    "bg-[url('/images/vbrandx/card-bg-3.webp')]",
    "bg-[url('/images/vbrandx/vb-banner-bg.webp')]",
