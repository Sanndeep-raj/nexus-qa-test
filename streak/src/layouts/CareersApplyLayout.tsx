...
const CareersApplyLayout = () => {
  console.info("Rendering Careers Apply Layout");
  return (
    <html dir="ltr" lang="en">
      ...
      <body>
        ...
        <main id="main-content">
          <WidgetPlaceholder id="CareersApply" type="CareersApply" />
...
export default CareersApplyLayout;
