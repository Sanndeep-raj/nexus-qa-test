    ...
    <section id="navsection" className="border-b border-t border-gray-400 bg-white sticky top-[76px] z-30">
      <div className="lg:container lg:flex lg:justify-center">
        <div className="relative lg:hidden">
          ...
          >
            {["Overview", "Capabilities", "Tech Stacks", "Why Us", "Process", "Case Studies", "FAQs"].map((item) => (
              <button
                key={item}
                id={item}
                data-item={item}
      ...
      <Script id="DpAutomationNav" options={{ sectionMap, reverseSectionMap }}>
...
export default DpAutomationNav;