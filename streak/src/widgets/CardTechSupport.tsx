...
const CardTechSupport = () => {
  return (
    <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between h-full rounded-lg overflow-hidden">
      <div className="xl:w-2/5">
        <img
          src="/images/partners/partners-2.webp"
          width={528}
          height={332}
          alt="Technology and support large view"
          className="h-full max-xl:hidden rounded-lg"
          loading="lazy"
        />
        <img
          src="/images/partners/partners-sm-2.webp"
          width={312}
          height={333}
          alt="Technology and support small view"
      ...
      <div className="max-xl:flex-1 py-8 xl:py-0 max-xl:h-full xl:w-1/2">
        <div className="flex justify-between flex-col h-full xl:w-[90%]">
          <h4 className="text-h5 xl:text-h4">
            Access to Industry-Leading Tech &amp; Support
          </h4>
          <p className="text-md xl:text-xxl mt-6 xl:mt-8">
            Leave the backend to us. With solid tools and responsive support,
            you stay focused on what you do best, serving and scaling.
          </p>
        </div>
      </div>
    </div>
...
export default CardTechSupport;
