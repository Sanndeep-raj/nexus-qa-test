    ...
    <section id="navsection" className="border-b border-t border-gray-400 bg-white sticky top-[76px] z-30">
      <div className="lg:container lg:flex lg:justify-center">
        <div className="relative lg:hidden">
          ...
          >
            {["Overview", "Services", "Tech Stacks", "Solutions", "Process", "Case Studies", "FAQs"].map((item) => (
              <button
                key={item}
                id={item}
                data-item={item}
      ...
      <Script id="DigitalCommerceNav" options={{ sectionMap, reverseSectionMap }}>
        {(gDom: any, options: any) => {
          ...
          const btn = document.querySelector('.btn_desktop[data-item="Overview"]') as HTMLElement | null;
...
export default DigitalCommerceNav;