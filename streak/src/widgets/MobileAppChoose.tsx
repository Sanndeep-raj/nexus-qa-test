...
const MobileChooseSection = ( props : ChooseSectionProps) => {
    ...
    <section className="border-t border-b py-12 xl:py-20 xxl:py-26" id={id}>
      <div className="container">
        <div className="lg:w-8/12 mb-8">
          ...
          <p className="text-h4 xl:text-h2 text-primary whitespace-pre-line">{heading}</p>
          <p className="text-xxl mt-8">{description}</p>
        </div>
