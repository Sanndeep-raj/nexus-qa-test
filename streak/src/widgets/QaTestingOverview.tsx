...
export type QATestingOverviewProps = {
  data: {
    heading?: string;
    subHeading?: string;
    intro?: string;
...
const QATestingOverview = (props: QATestingOverviewProps) => {
    ...
    <section className="py-16 lg:py-26 overflow-hidden" id="overview">
      <div className="container">
        ...
        <div className="lg:w-8/12">
          ...
          <p className="text-h4 xl:text-h2 text-primary whitespace-pre-line">{subHeading}</p>
          <p className="text-xxl mt-8">{intro}</p>
        </div>
