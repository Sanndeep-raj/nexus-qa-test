...
const AIMLRelatedServices = (props: Props) => {
  const slides = props?.data;

  return (
    <section
      className="relative text-black bg-white overflow-hidden pb-6 xl:pb-10"
      id="related_services"
    >
...
export default AIMLRelatedServices;
