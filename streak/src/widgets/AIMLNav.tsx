...
const AIMLNav = () => {
  ...
  return (
    <section
      id="navsection"
      className="border-b border-t border-gray-400 bg-white sticky top-[76px] z-30"
    >
      ...
      <Script
        id="CloudModernizationNav"
        options={{ sectionMap, reverseSectionMap }}
      >
        {(gDom: any, options: any) => {
          ...
          const btn = document.querySelector(
            '.btn_desktop[data-item="Services"]'
          ) as HTMLElement | null;
          ...
          const updateActiveButton = (label: string) => {
            document.querySelectorAll(".btn_desktop").forEach((btn) => {
              ...
              (btn as HTMLElement).style.borderBottom = "1px solid #9ca3af";
