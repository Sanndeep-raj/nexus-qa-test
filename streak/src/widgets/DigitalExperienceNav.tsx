...
const DigitalExperienceNav = () => {
  const sectionMap = {
    Overview: "over",
    Services: "overview",
    "Trusted Allies": "tech-stacks",
    "Why Us": "choose",
    Process: "process",
  ...
  return (
    <section id="navsection" className="border-b border-t border-gray-400 bg-white sticky top-[76px] z-30">
      ...
      <Script id="DigitalExperienceNav" options={{ sectionMap, reverseSectionMap }}>
...
export default DigitalExperienceNav;